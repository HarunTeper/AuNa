#ifndef AUNA_CONTROL_CONTROL_PANEL_ROS_INTERFACE_HPP_
#define AUNA_CONTROL_CONTROL_PANEL_ROS_INTERFACE_HPP_
...
#endif  // AUNA_CONTROL_CONTROL_PANEL_ROS_INTERFACE_HPP_
