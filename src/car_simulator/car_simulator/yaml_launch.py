...
# Input:
#   Subfolder: subfolder in /car_simulator/config
#   filename: filename in /car_simulator/config/subfolder
def get_yaml(subfolder, filename):
...
def get_yaml_value(subfolder, filename, keys):
